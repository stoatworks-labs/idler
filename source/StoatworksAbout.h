/*
 * Stoatworks Labs - About window data for Idler.
 *
...
{
    inline constexpr auto name = "Idler";
    inline constexpr auto slug = "idler";
    inline constexpr auto hook = "The Windows 95/98 screensavers, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/idler/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/idler/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/idler";
    inline constexpr auto versionFallback = "v1.0.10";
